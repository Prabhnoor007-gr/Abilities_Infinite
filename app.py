...
def upload_image():
    ...
    if file and allowed_file(file.filename):
        ...
        if os.path.exists(r"C:\Users\Lenovo\PycharmProjects\ablities\static\process\exp"):
            shutil.rmtree(r"C:\Users\Lenovo\PycharmProjects\ablities\static\process\exp", ignore_errors=True)
